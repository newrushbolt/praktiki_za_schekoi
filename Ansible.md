...
При использовании подхода "инфраструктура как код" было бы странно применять только версионирование и  
  игнорировать другие практики, например тестирование изменений, CI/CD, канареечные релизы и прочее.  
  Однако, главный вопрос, который обычно возникает при попытке внедрить подобные практики это не  
  "Зачем?", а "Как?". Если коротко, то в случае Ansible ответ один: [Molecule](https://molecule.readthedocs.io/en/stable/).
