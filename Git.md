...
Git репозиторий используется не просто так. Предполагается, что с ним работает некоторое кол-во участников.  
Все мы смотрим на мир и понимаем его по разному, это касается и исходных кодов. Каждый участник/сотрудник понимает  
задачу по своему и имеет свое представление о стиле и качестве написания кода/покрытия тестами/используемых алгоритмах  
и конструкций применяемого языка. Для приведения всего этого творчества в единный стрим, существует различный набор  
style guide применяемых в команде. Подобные соглашения являются результатом фиксации общих договоренностей и необходимы  
для того, что бы результат деятельности каждого из членов комманды был легко читаем и воспринимаемым каждым членом  
комманды, соответствовал прочим требования по производительности, переносимости кода и прочим иным договоренностям,  
отраженным в style guide.
  
Code review процесс призван обнаружить и решить некоторый список потенциальных или реальных проблем еще до того,  
как они будут смержены в продакшен или стейджинг окружения. Ниже некоторый список проблем, которые code review призван  
решить в идеале:
