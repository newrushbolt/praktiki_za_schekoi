...
чтобы результат деятельности каждого из членов команды был читаем для каждого в команде,  
...
* **Повышение общего уровня владения кодом**  
    Регулярный анализ кода членами группы приводит к тому, что все члены группы знакомятся как с новым,  
