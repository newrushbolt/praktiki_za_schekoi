...
* [Как](#как)  
    * [Коммиты](#коммиты)  
    * [Ветки](#ветки)  
    * [Реквесты/ревью](#реквесты/ревью)  
* [Инструменты и примеры](#инструменты-и-примеры)  
...
* [Code review](#code-review)  
    * [Что можно инспектировать](#что-можно-инспектировать)  
...
При существенных размерах группы, review проводят более опытные коллеги, которые выделяют для этого некоторо время.  
...
* **Уважайте время своих коллег**  
    ...
    Если реквест "висит" без review продолжитeльное время, то результат работы вашего колeлги не может быть использован.  
...
* **Обязательно включайте в review коллег предыдущего грейда**  
   ...
   очередь упрощает дальнейшее развитие и сопровождение кода всей командой.
